...
func TestConfigureInstance_Valid(t *testing.T) {
	...
	if err := svc.ConfigureInstance(context.Background(), "My Luma", "en-US", "America/New_York"); err != nil {
...
func TestConfigureInstance_InvalidTimezone(t *testing.T) {
	svc := serviceFor(StateSetup)
	err := svc.ConfigureInstance(context.Background(), "My Luma", "en-US", "Not/ATimezone")
	if err == nil {
...
func TestConfigureInstance_InvalidLocale(t *testing.T) {
	svc := serviceFor(StateSetup)
	err := svc.ConfigureInstance(context.Background(), "My Luma", "not valid locale!", "UTC")
	if err == nil {
...
func TestConfigureInstance_WrongState(t *testing.T) {
	...
	err := svc.ConfigureInstance(context.Background(), "My Luma", "en-US", "UTC")
	if err == nil {
