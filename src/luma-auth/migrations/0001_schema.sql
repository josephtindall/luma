...
CREATE TABLE auth.instance (
    ...
    CONSTRAINT setup_state_values CHECK (
        setup_state IN (
            'unclaimed',
            'setup',
            'active'
    ...
    CONSTRAINT content_width_values CHECK (
        content_width IN ('narrow', 'wide', 'max')
    )
);
...
CREATE TABLE auth.devices (
    ...
    created_at TIMESTAMPTZ NOT NULL DEFAULT NOW(),
    CONSTRAINT platform_values CHECK (
        platform IN (
            'web',
            'ios',
            'android',
...
CREATE TABLE auth.password_reset_tokens (
    ...
    consumed_at TIMESTAMPTZ,
    created_at TIMESTAMPTZ NOT NULL DEFAULT NOW(),
    CONSTRAINT prt_source_values CHECK (
        source IN ('admin_reset', 'force_change')
    )
);
...
CREATE TABLE auth.invitations (
    ...
    revoked_at TIMESTAMPTZ,
    created_at TIMESTAMPTZ NOT NULL DEFAULT NOW(),
    CONSTRAINT invitation_status_values CHECK (
        status IN (
            'pending',
            'accepted',
            'expired',
...
CREATE TABLE auth.roles (
    ...
    created_by UUID,
    created_at TIMESTAMPTZ NOT NULL DEFAULT NOW(),
    CONSTRAINT role_scope_values CHECK (
        scope IN ('instance', 'vault')
    )
);
...
CREATE INDEX idx_resource_perms ON auth.resource_permissions (
    resource_type,
    resource_id,
    subject_type,
    subject_id
...
INSERT INTO
    auth.roles (id, name, scope, is_builtin)
VALUES (
        'builtin:instance-owner',
        'Owner',
        'instance',
        true
    ),
    (
        'builtin:instance-member',
        'Member',
        'instance',
        true
    ),
    ...
    (
        'builtin:vault-editor',
        'Editor',
        'vault',
        true
    ),
    (
        'builtin:vault-viewer',
        'Viewer',
        'vault',
        true
    );
...
VALUES (
    ...
    (
        ...
        'member-base',
        'Base permissions for instance members',
        true
    ),
    (
        '00000000-0000-0000-0000-000000000003',
        'vault-admin-all',
        'All content and membership actions in a vault',
        true
    ),
    (
        '00000000-0000-0000-0000-000000000004',
        'vault-editor',
        'Create, edit, delete content in a vault',
        true
    ),
    (
...
VALUES
    ...
    ('00000000-0000-0000-0000-000000000001', 'allow',
     ARRAY[
         ...
         'audit:read-own', 'audit:read-all', 'audit:export-all', 'audit:read-pii',
...
INSERT INTO
    auth.role_policies (role_id, policy_id)
VALUES (
        'builtin:instance-owner',
        '00000000-0000-0000-0000-000000000001'
    ),
...
INSERT INTO
    auth.custom_roles (id, name, priority, is_system)
VALUES (
        '00000000-0000-0000-0000-000000000001',
        'Full Control',
        0,
